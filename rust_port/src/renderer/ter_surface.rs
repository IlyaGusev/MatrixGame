...
use crate::game::common::{rd_i32, rd_u32, rd_f32, rd_u16};
use crate::game::map::GameMap;
use crate::renderer::texture::{decode_texture_bytes, create_texture_from_rgba_mipped, create_solid_texture};
use super::terrain::{Vertex, DrawBatch};
...
pub fn build_surface_overlays(
    ...
    for surf in &surfaces {
        if surf.indices.len() < 3 { continue; }
        ...
        let bg = device.create_bind_group(&wgpu::BindGroupDescriptor {
            ...
            entries: &[
                ...
                wgpu::BindGroupEntry { binding: 2, resource: wgpu::BindingResource::Sampler(if surf.wrap_y { sampler_wrap_v } else { sampler_clamp }) },
